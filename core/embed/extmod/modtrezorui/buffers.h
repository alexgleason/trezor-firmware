...
buffer_line_16bpp_t* buffers_get_line_16bpp(uint16_t idx, bool clear);
void buffers_free_line_16bpp(buffer_line_16bpp_t* buffer);

buffer_line_4bpp_t* buffers_get_line_4bpp(uint16_t idx, bool clear);
void buffers_free_line_4bpp(buffer_line_4bpp_t* buffer);

buffer_text_t* buffers_get_text(uint16_t idx, bool clear);
void buffers_free_text(buffer_text_t* buffer);

buffer_jpeg_t* buffers_get_jpeg(uint16_t idx, bool clear);
void buffers_free_jpeg(buffer_jpeg_t* buffer);

buffer_jpeg_work_t* buffers_get_jpeg_work(uint16_t idx, bool clear);
void buffers_free_jpeg_work(buffer_jpeg_work_t* buffer);

buffer_blurring_t* buffers_get_blurring(uint16_t idx, bool clear);
