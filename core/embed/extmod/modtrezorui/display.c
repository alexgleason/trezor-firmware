...
void display_image(int x, int y, int w, int h, const void *data,
  ...
  buffer_line_16bpp_t *b1 = buffers_get_line_16bpp(0, false);
  if (b1 == NULL) return;
  buffer_line_16bpp_t *b2 = buffers_get_line_16bpp(1, false);
  if (b2 == NULL) {
...
void display_icon(int x, int y, int w, int h, const void *data,
  ...
  buffer_line_4bpp_t *b1 = buffers_get_line_4bpp(0, false);
  if (b1 == NULL) return;
  buffer_line_4bpp_t *b2 = buffers_get_line_4bpp(1, false);
  if (b2 == NULL) {
