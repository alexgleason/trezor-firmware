...
mod tests {
    ...
    fn paragraphs_one_long() {
        ...
        let expected2 = "<SwipePage active_page:1 page_count:2 content:<Paragraphs  **CONTENT** guess. There's just so\nmuch letters in it.\n **CONTENT** > buttons:<FixedHeightBar inner:<Button text:NO > > >";
    ...
    fn paragraphs_three_long() {
        ...
        let expected2 = "<SwipePage active_page:1 page_count:3 content:<Paragraphs  **CONTENT** ...they have th\ne same width and\ncan be scanned q\nuickly. Even if\nthey span severa\nl pages or somet\nhing.\n **CONTENT** > buttons:<FixedHeightBar inner:<Button text:IDK > > >";
        let expected3 = "<SwipePage active_page:2 page_count:3 content:<Paragraphs  **CONTENT** Let's add another one\nfor a good measure. This\none should overflow all\nthe way to the third\npage with a bit of luck.\n **CONTENT** > buttons:<FixedHeightBar inner:<Button text:IDK > > >";
