...
mod tests {
    ...
    fn paragraphs_three_long() {
        ...
        let expected2 = "<SwipePage active_page::1,page_count::3,content:<Paragraphs  **CONTENT** ..y have the sam\ne width and can\nbe scanned quick\nly. Even if they\nspan several pag\nes or something.\nLet's add another one...\n **CONTENT** > buttons:<FixedHeightBar inner:<Button text:IDK > > >";
        let expected3 = "<SwipePage active_page::2,page_count::3,content:<Paragraphs  **CONTENT** ..for a good measure.\nThis one should overflow\nall the way to the third\npage with a bit of luck.\n **CONTENT** > buttons:<FixedHeightBar inner:<Button text:IDK > > >";
