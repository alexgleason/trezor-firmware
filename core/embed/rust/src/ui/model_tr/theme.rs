...
pub const TEXT_MONO: TextStyle = TEXT_MONO_RAW
    .with_ellipsis_icon(ICON_NEXT_PAGE)
    .with_prev_page_icon(ICON_PREV_PAGE);
...
pub const ICON_LOGO: &[u8] = include_res!("model_tr/res/logo.toif"); // 26*39
