...
let
  ...
  moneroTests = nixpkgs.fetchurl {
    url = "https://github.com/ph4r05/monero/releases/download/v0.18.1.1-dev-tests-u18.04-01/trezor_tests";
    sha256 = "ba985cd0c440b98740d26be62f04dddabc4bd3896ab298bc40f45cbde32419bb";
  };
